/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: dafbb568a2726a589662cd841e35d113)
...
declare namespace Cloudflare {
	interface Env {
		...
		CLOUDFLARE_AI_SEARCH_INDEX: string;
		CLOUDFLARE_AI_SEARCH_API_TOKEN: string;
		BOOK_MD_BUCKET: R2Bucket;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
